...
def datasets_from_params(params: Params) -> Dict[str, Iterable[Instance]]:
    ...
    if validation_dataset_reader_params is not None:
        logger.info("Using a separate dataset reader to load validation and src data.")
    ...
    if test_data_path is not None:
        logger.info("Reading src data from %s", test_data_path)
        test_data = validation_and_test_dataset_reader.read(test_data_path)
        datasets["src"] = test_data
...
def train_model(params: Params,
    ...
    test_data = all_datasets.get('src')
    ...
    if test_data and evaluate_on_test:
        ...
        logger.info("To evaluate on the src set after training, pass the "
