...
def main():
    data_folder = "/afs/inf.ed.ac.uk/user/s15/s1544871/Data/2009_conll_p1/data/CoNLL2009-ST-Japanese/"
    ...
    dev_data = reader.read(data_folder +"CoNLL2009-ST-evaluation-Japanese.txt")
