...
import math
@Model.register("var_biaffine_parser")
class VariationalBiaffineDependencyParser(Model):
    """
    ...
    def __init__(self,
        ...
        super(VariationalBiaffineDependencyParser, self).__init__(vocab, regularizer)
        ...
        if pos_tag_embedding is not None:
            ...
            #
            # self.pos_score = FeedForward(arc_representation_dim*2, 1,
            #                              pos_tag_embedding.num_embeddings,
            #                                             Activation.by_name("elu")())
            # self.pos_score_log_var = FeedForward(arc_representation_dim*2, 1,
            #                              pos_tag_embedding.num_embeddings,
            #                                             Activation.by_name("elu")())
    ...
    def forward(self,  # type: ignore
        ...
        if head_indices is not None and head_tags is not None:
            ...
            arc_nll, tag_nll,kl_div = self._construct_loss(head_tag_representation=head_tag_representation,
