...
@Model.register("vargumbel_biaffine_parser")
class varGumbelBiaffineDependencyParser(Model):
    """
    ...
    def __init__(self,
        ...
        super(varGumbelBiaffineDependencyParser, self).__init__(vocab, regularizer)
