...
@Model.register("stacked_biaffine_parser")
class StackedBiaffineDependencyParser(Model):
    """
    ...
    def __init__(self,
        ...
        super(StackedBiaffineDependencyParser, self).__init__(vocab, regularizer)
