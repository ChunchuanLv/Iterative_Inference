...
class GraphAutoEncoder1(Seq2SeqEncoder):
    ...
    def __init__(self,
        ...
        super(GraphAutoEncoder1, self).__init__()
    ...
    def get_computation_graph(self,
        ...
        graph = ComputationGraph(["linear_role_scores"], ["predicate_emb", "arc_tag_probs"] )
    ...
    def score(self, graph: ComputationGraph, graph_mask):
        ...
        return None, self.h(linear_edge_scores) * graph_mask

    def score_gradient(self, graph: ComputationGraph, graph_mask: torch.Tensor):
        linear_edge_scores = graph.get_tensor_by_name("linear_role_scores")

        return  self._dropout (self.sigmoid(linear_edge_scores) * graph_mask)
