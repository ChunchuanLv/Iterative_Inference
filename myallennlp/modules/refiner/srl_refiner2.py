...
@Seq2SeqEncoder.register("srl_refiner2")
class SRLRefiner2(Seq2SeqEncoder):
    ...
    #    print ("predicate_representation",predicate_representation.size())
        ...
        if self.gating and old_score_nodes is not None and old_score_edges is not None:
            ...
            score_nodes = torch.max(score_nodes, old_score_nodes)
            ...
            score_edges = score_edges * update_mask + old_score_edges * old_mask
            ...
            score_nodes = score_nodes * sense_update_mask + old_score_nodes * old_sense_mask
