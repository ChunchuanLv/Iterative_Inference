...
class MultiHeadSelfAttentionWithScore(Seq2SeqEncoder):
    ...
    def __init__(self,
        ...
        super(MultiHeadSelfAttentionWithScore, self).__init__()
    ...
    def forward(self,  # pylint: disable=arguments-differ
        ...
        scaled_similarities = scaled_similarities.view(batch_size,num_heads,timesteps,timesteps)
        ...
        return outputs, scaled_similarities[:,0,:,:]
