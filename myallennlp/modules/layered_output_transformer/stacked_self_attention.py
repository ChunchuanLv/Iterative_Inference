...
from myallennlp.modules.layered_output_transformer import MultiHeadSelfAttentionWithScore

@Seq2SeqEncoder.register("stacked_output_self_attention")
class StackedOutputSelfAttentionEncoder(Seq2SeqEncoder):
    ...
    def __init__(self,
        ...
        super(StackedOutputSelfAttentionEncoder, self).__init__()
        ...
        for i in range(num_layers):
            ...
            self_attention = MultiHeadSelfAttentionWithScore(num_heads=num_attention_heads,
    ...
    def forward(self, inputs: torch.Tensor, mask: torch.Tensor): # pylint: disable=arguments-differ
        ...
        for (attention,
            ...
            attention_output, arch_scores = attention(feedforward_output, mask)
            output = layer_norm(self.dropout(attention_output) + feedforward_output)

            output_list.append(output)
            score_list.append(arch_scores)

        return output_list,score_list
